#!/usr/bin/env python3
"""
Fine-tuning script for NVIDIA Nemotron Speech Streaming 0.6B on Custom ASR Data
Uses NVIDIA NeMo framework for training

Nemotron Speech Streaming Features:
- Cache-aware streaming architecture for low-latency inference
    ...
    nemo_config = {
        ...
        **init_config,  # Add init_from_nemo_model or init_from_pretrained_model
        ...
        'exp_manager': {
            ...
            'name': config['training'].get('run_name', 'nemotron-asr-finetuning'),
            ...
            'checkpoint_callback_params': {
                ...
                'filename': 'nemotron-asr--{epoch:02d}-{step}-{val_wer:.4f}',
                'save_last': True,
            },
...
def print_training_info(config: Dict, nemo_config: OmegaConf):
    ...
    logging.info("\n" + "="*70)
    logging.info("NVIDIA Nemotron Speech Streaming Training Configuration")
    logging.info("="*70)
...
def train(config_path: str):
    ...
    try:
        ...
        logging.info(f"Checkpoints: {output_dir}/nemotron-asr-finetuning/*/checkpoints/")
        logging.info("="*70 + "\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fine-tune NVIDIA Nemotron Speech Streaming 0.6B on custom ASR data",
